...
How to use the code:
-------------------
1. INPUT: dyn_3Nx3N-bulk.dat and example-dyn_3Nx3N-connection.dat are from the folder "DynMatrix-Gamma/bulk"
...
2. INPUT: dyn_3Rx3R-device.dat is from the folder "DynMatrix-Gamma/surface"
